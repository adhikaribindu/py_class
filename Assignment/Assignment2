...
list_of_student={1:70, 2:30, 3:90, 4:75, 5:88, 6:86, 7:76, 8:66, 9:40} 
pass_count=0

for key,value in list_of_student.items():
    if value>50:
        pass_count=pass_count+1
        print(key,":",value)
    else:
        pass
print("The total number of pass student are",pass_count)
